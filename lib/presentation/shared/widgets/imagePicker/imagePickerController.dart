...
class imagePickerController extends GetxController {
  ...
  // List to store multiple images (increased limit to 8)
  ...
  /// Adds image to the list with native compression (max 8 images)
  Future<void> addImage(File image) async {
    if (selectedImages.length < maxImages) {
      ...
      print('Maximum of $maxImages images allowed');
...
// Add this method to your existing imagePickerController class
